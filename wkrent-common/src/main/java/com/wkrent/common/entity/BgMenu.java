...
public class BgMenu implements Serializable {
    ...
    /**
     * 
     * @return bg_memu_id 菜单Id,唯一标识
     */
    public String getBgMemuId() {
        return bgMemuId;
    }

    /**
     * 
     * @param bgMemuId 菜单Id,唯一标识
     */
    public void setBgMemuId(String bgMemuId) {
        this.bgMemuId = bgMemuId == null ? null : bgMemuId.trim();
    }
