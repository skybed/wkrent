 ...
 */
@ApiModel
public class BgRoomVO implements Serializable {
    ...
    public List<String> getRoomLabelIdList() {
        return roomLabelIdList;
    }
    ...
    public String getBgRoomTipsText() {
        return bgRoomTipsText;
    }
